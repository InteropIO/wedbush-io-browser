...
const WorkspaceTabOptionsPopup: React.FC<OptionsPopupProps> = ({
  workspaceId,
  buttonBounds,
  showSaveButton,
  lockConfig,
  ...
  return (
    ...
    >
      {!lockSelected && !saveSelected && (
        <OptionsList
          showSaveButton={showSaveButton}
          onCloseClicked={closeWorkspace}
          onLockClicked={() => setLockSelected(true)}
          onSaveClicked={() => setSaveSelected(true)}
        />
      )}
      {saveSelected && (
        <Save hidePopup={hidePopup} workspaceId={workspaceId} onBackClick={onBackClick} />
      )}
      {lockSelected && (
        <LockOptions
          showBackButton={true}
